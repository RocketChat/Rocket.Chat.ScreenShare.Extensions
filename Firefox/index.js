// FORKED FROM https://github.com/muaz-khan/Firefox-Extensions

var tabs = require("sdk/tabs");

tabs.on('ready', function(tab) {
  tab.attach({
      contentScript: 'unsafeWindow.rocketchatscreenshare = "firefox";'
  });
});
...
var arrayOfMyOwnDomains = ['demo.rocket.chat'];

// e.g. if 127.0.0.1 or localhost is already allowed by anyone else
var listOfSimilarAlreadyAllowedDomains = ['localhost', '127.0.0.1'];
